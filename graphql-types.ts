...
export type GetAboutUsDataQuery = {
  allDataJson: {
    nodes: Array<
      Pick<
        DataJson,
...
export type BackgroundQueryQuery = {
  file?: Maybe<{
...
export type CampingImageQueryQuery = {
...
export type GetMetadataQuery = {
  site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'link'>> }>
}
